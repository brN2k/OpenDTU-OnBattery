...
private:
    ...
    static void addTotalField(JsonObject& root, const String& name, const float value, const String& unit, const uint8_t digits, bool stale = false, bool error = false);
